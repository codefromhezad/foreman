...
if( self.document !== undefined ) {
    ...
    var Foreman = function() {
        ...
        this.send = function(action, data) {
            ...
            if( $this.LOG_COMMUNICATIONS && ! action.match(/^__foreman/) ) $this.log('<<< Sent message with action "'+action+'"');
            return $this;
        } 
    ...
    var Foreman = function() {
        ...
        this.send = function(action, data) {
            ...
            if( $this.LOG_COMMUNICATIONS && ! action.match(/^__foreman/)) log('>>> Sent message with action "'+action+'"');
            return $this;
        } 
